      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button
            ...
            onClick={onOpen}
            color="white"
            _hover={{ background: "blue.400", color: "black.400" }}
        ...
        <div>
          ...
          <Menu>
            <MenuButton
              ...
              _hover={{ background: "blue.400", color: "yellow.400" }}
              _active={{ background: "blue.400", color: "yellow.400" }}
            >
              <Avatar
                size="sm"
                cursor="pointer"
            ...
            <MenuList bg="blue.400" borderColor="black" borderWidth="2px">
